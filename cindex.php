...
<head>
  ...
  <?php $note ="";
    ...
    { 
      ...
      $note = "<div class='alert alert-success'>Transaction Successful</div>";
      else
...
<div class="row w-100" style="padding: 11px">
  <div class="col">
    <div class="card text-center w-50 mx-auto shadowBlack">
    ...
    <p class="card-text"><?php echo $note; ?>
      <form method="POST">
          <div class="alert alert-secondary w-50 mx-auto">
            ...
            <button type="submit" name="get" class="btn btn-primary btn-bloc btn-sm mt-2">Get Account Info</button>
          </div>
      </form>
    </p>
